...
nugl__canvas_init (nugl__renderpass_canvas_t *pass)
{
    ...
    NU_VEC_ALLOC(&pass->blit_transfer, 128);
...
{
    NU_ASSERT(material);
    const nu__material_t *pmat = (const nu__material_t *)material;
    ...
    const nugfx__texture_t *tex0    = (const nugfx__texture_t *)pmat->canvas.texture0;
