...
nu_bool_t
nu_input_changed (const nu_platform_t *platform, nu_input_t input)
{
...
nu_bool_t
nu_input_pressed (const nu_platform_t *platform, nu_input_t input)
{
    const nu__input_state_t *state
        = nuglfw__input_state(&platform->_input.glfw, input);
...
nu_bool_t
nu_input_just_pressed (const nu_platform_t *platform, nu_input_t input)
{
    const nu__input_state_t *state
        = nuglfw__input_state(&platform->_input.glfw, input);
    return NU_INPUT_IS_PRESSED(state->value)
...
nu_bool_t
nu_input_released (const nu_platform_t *platform, nu_input_t input)
{
    const nu__input_state_t *state
        = nuglfw__input_state(&platform->_input.glfw, input);
    return !NU_INPUT_IS_PRESSED(state->value);
...
nu_bool_t
nu_input_just_released (const nu_platform_t *platform, nu_input_t input)
{
    const nu__input_state_t *state
        = nuglfw__input_state(&platform->_input.glfw, input);
    return !NU_INPUT_IS_PRESSED(state->value)
...
float
nu_input_value (const nu_platform_t *platform, nu_input_t input)
{
    const nu__input_state_t *state
        = nuglfw__input_state(&platform->_input.glfw, input);
    return state->value;
