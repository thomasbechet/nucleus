...
#define NU_OBJECT_SERIA        "seria"
#define NU_OBJECT_SERIA_STRUCT "seria_struct"
#define NU_OBJECT_SERIA_ENUM   "seria_enum"
...
NU_API void nu_seria_dump_struct(nu_seria_struct_t s,
                                 nu_size_t         size,
                                 void             *data);
NU_API void nu_seria_dump_enum(nu_seria_enum_t e, nu_size_t size, void *data);
...
NU_API void nu_seria_read_ref(nu_seria_t          seria,
                              ...
                              nu_size_t           count,
                              nu_object_t        *ref);
NU_API void nu_seria_write_str(nu_seria_t seria, nu_str_t name, nu_str_t str);
